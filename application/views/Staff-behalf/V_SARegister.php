                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">AdMas Staff Register</h3></div>
                                    <div class="card-body">
                                    <form action="<?= base_url('C_Auth/SAregister') ?>" method="post">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="<?= base_url('C_View/SAlogin')?>">Have an account already?</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
